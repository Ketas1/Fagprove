...
import { AlertTriangle, Camera, Check, Plus } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              <span className="text-[12.5px] font-medium text-muted-foreground">Bilde av utstyr før utlån</span>
              <NotBuiltYetBadge reason="Det finnes ingen filopplasting eller bildelagring i API-et ennå - se docs/13-frontend-designsystem.md." />
            </div>
